...
MASTER = str(ALIVE_NAME) if ALIVE_NAME else "USERBOT"
NAME = os.environ.get("BOT_NICK_NAME")
BOT =  = str(NAME) if NAME else "BLACK LIGHTNING"
#op for keinshin

Keinshin = "[AKASH](https://t.me/BeingImimmortal)"
OP = "[LOL](https://github.com)"
OKAY = "[SUPPORT GROUP](https://t.me/BeingImimmortal)"
